...
export default function WhatWeOffer() {
  return (
    <section className="mx-auto my-16 w-11/12 max-w-screen-2xl rounded-3xl bg-[#FCF9FA] px-12 py-12">
      ...
      <div className="mt-8 grid gap-4 lg:mt-16 lg:grid-cols-2 lg:gap-12">
        ...
        <div className="flex flex-col justify-center">
          <h3 className="text-dark mt-4 text-2xl font-light md:text-3xl lg:mt-0">
            Offbeat Destinations
          </h3>
          <p className="text-green mt-2 leading-7">
          ...
          <h3 className="text-dark mt-10 text-2xl font-light md:text-3xl">
